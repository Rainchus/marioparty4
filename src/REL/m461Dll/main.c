...
float lbl_1_data_30[10] = {
    70, 70, 70, 70, 70, 70, 70, 70, 70, 100
};

float lbl_1_data_58[10] = {
    150, 170, 190, 170, 160, 150, 180, 200, 150, 200
};
...
s32 lbl_1_data_128[8][5] = {
    0x005F0000, 0x005F0002, 0x005F0003, 0x005F0014, 0x005F0017,
    0x001A0000, 0x001A0002, 0x001A0003, 0x001A0014, 0x001A0017,
    0x006D0000, 0x006D0002, 0x006D0003, 0x006D0014, 0x006D0017,
    0x008A0000, 0x008A0002, 0x008A0003, 0x008A0014, 0x008A0017,
    0x00850000, 0x00850002, 0x00850003, 0x00850014, 0x00850017,
    0x00110000, 0x00110002, 0x00110003, 0x00110014, 0x00110017,
    0x000D0000, 0x000D0002, 0x000D0003, 0x000D0014, 0x000D0017,
    0x00810000, 0x00810002, 0x00810003, 0x00810014, 0x00810017
};

s32 lbl_1_data_1C8[3] = {
    0x005A0002,
    0x005A0003,
    0x005A0008
};
...
Data270Struct lbl_1_data_270[8] = {
    {{ 200,  0,  1400 }, 180 },
    {{ -200,  0,  1400 }, 180 },
    {{ 200,  0,  -1400 }, 0 },
    {{ -200,  0,  -1400 }, 0 },
...
void fn_1_512C(void)
{
    ...
    print8(24, 32, 1.5f, "COUNT:%d MODE:%d MES:%d %d/%d %02x", lbl_1_bss_204, lbl_1_bss_A0->work[0], lbl_1_bss_1FA, lbl_1_bss_20, lbl_1_bss_24, lbl_1_bss_28);
...
{
    s32 i;
    obj->model[0] = Hu3DModelCreateFile(0x5A0000);
    ...
    omSetTra(obj, 0, 0, 0);
    omSetRot(obj, 0, 0, 0);
    obj->model[1] = Hu3DModelCreateFile(0x5A0001);
...
void ObjectSetup(void)
{
    ...
    for(i=0; i<20; i++) {
        s32 modelId;
        lbl_1_bss_4C[i] = NULL;
        modelId = Hu3DModelCreateFile(0x5A0008);
