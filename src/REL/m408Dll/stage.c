...
void fn_1_C530(omObjData *object)
{
	...
	lbl_1_bss_14C[0] = HuSprAnimRead(HuDataReadNum(0x270024, MEMORY_DEFAULT_NUM));
	lbl_1_bss_14C[1] = HuSprAnimRead(HuDataReadNum(0x270025, MEMORY_DEFAULT_NUM));
	lbl_1_bss_14C[2] = HuSprAnimRead(HuDataReadNum(0x270026, MEMORY_DEFAULT_NUM));
	lbl_1_bss_14C[4] = HuSprAnimRead(HuDataReadNum(0x270028, MEMORY_DEFAULT_NUM));
	lbl_1_bss_14C[3] = HuSprAnimRead(HuDataReadNum(0x270029, MEMORY_DEFAULT_NUM));
	object->model[0] = Hu3DModelCreateFile(0x27001A);
	omSetSca(object, 0.1f, 0.1f, 0.1f);
	temp_r31 = object->model[0];
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelAttrSet(temp_r31, 1);
	object->model[4] = Hu3DModelCreateFile(0x27001E);
	temp_r31 = object->model[4];
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelScaleSet(temp_r31, 0.1f, 0.1f, 0.1f);
	Hu3DModelAttrSet(temp_r31, 1);
	object->model[5] = Hu3DModelCreateFile(0x270020);
	temp_r31 = object->model[5];
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelScaleSet(temp_r31, 0.1f, 0.1f, 0.1f);
	object->model[2] = Hu3DModelCreateFile(0x27001B);
	temp_r31 = object->model[2];
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelPosSet(temp_r31, -20, -10, -150);
	Hu3DModelScaleSet(temp_r31, 0.14500001f, 0.14500001f, 0.14500001f);
	Hu3DModelAttrSet(temp_r31, 1);
	object->model[3] = Hu3DModelCreateFile(0x27001D);
	...
	object->model[9] = Hu3DModelCreateFile(0x27001C);
	...
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelAttrSet(temp_r31, 1);
	object->model[11] = Hu3DModelCreateFile(0x27001F);
	temp_r31 = object->model[11];
	Hu3DModelPosSet(temp_r31, 0, 10000, 0);
	Hu3DModelLayerSet(temp_r31, 1);
	Hu3DModelScaleSet(temp_r31, 0.105f, 0.1f, 0.105f);
	Hu3DModelAttrSet(temp_r31, 1);
	object->model[12] = Hu3DModelCreateFile(0x270023);
	...
	object->model[16] = Hu3DModelCreateFile(0x270021);
	object->model[17] = Hu3DModelCreateFile(0x270022);
	...
	switch(temp_r30->unk_02) {
		case 0:
			...
			for(temp_r28=0; temp_r28<particle->unk_30; temp_r28++, temp_r31++) {
				...
				temp_r31->unk24 = temp_r31->unk2C = temp_r30->unk_04.x+(0.01*((50.0f*temp_r30->unk_04.x)*((1.0/65536.0)*(float)fn_1_11670())));
				temp_r26 = frand()&0x7F;
				temp_r31->unk40.r = temp_r26+64;
				temp_r31->unk40.g = temp_r26+64;
				temp_f31 -= temp_r30->unk_04.x;
				temp_r31->unk40.a = 32+(int)((48.0f*temp_f31)/(0.2f*temp_r30->unk_04.x))+(int)(32*((1.0/65536.0)*(float)fn_1_11670()));
			}
			temp_r30->unk_02++;
