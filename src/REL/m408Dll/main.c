...
void fn_1_26E4(omObjData *object)
{
	...
	temp_r27 = Hu3DParticleCreate(HuSprAnimReadFile(0x270024), 256);
...
void fn_1_61FC(omObjData *object)
{
	...
	for(temp_r28=0; temp_r28<4; temp_r28++, temp_r31++) {
		...
		temp_r26 = espEntry(0x610029, 4, 0);
		temp_r31->unk54[0] = temp_r26;
		espColorSet(temp_r26, 0, 0, 0);
		espTPLvlSet(temp_r26, 0.5);
		temp_r31->unk54[1] = espEntry(0x610028, 3, 0);
		temp_r31->unk54[2] = espEntry(lbl_1_data_0[GWPlayerCfg[temp_r28].character], 2, 0);
		temp_r31->unk54[3] = espEntry(0x27002B, 2, 0);
		temp_r31->unk54[4] = espEntry(0x610008, 2, 0);
		temp_r31->unk54[6] = espEntry(0x610033, 2, 0);
		temp_r31->unk54[5] = espEntry(0x610033, 2, 0);
		for(temp_r30=0; temp_r30<7; temp_r30++) {
...
float fn_1_68C4(float arg8, float arg9, float argA, float argB, float argC, float argD, float argE, float argF, float arg2, float arg3)
{
	...
	temp_f26 = 2.0f * ((argE * arg2) + ((((arg9 * argB) + ((argD * argF) + (((arg8 * argA) - (arg8 * argF)) - (argD * argA)))) - (arg9 * arg2)) - (argE * argB)));
...
void fn_1_7818(omObjData *arg0, omObjData *arg1)
{
	...
	float spC;
	float sp8;
	fn_1_6F4C(temp_r31->unk1C.x, temp_r31->unk1C.z, temp_r31->unk34.x, temp_r31->unk34.z, 
		temp_r30->unk1C.x, temp_r30->unk1C.z, temp_r30->unk34.x, temp_r30->unk34.z,
		&sp14, &sp10, &spC, &sp8);
...
s32 fn_1_78D8(void)
{
	...
	for(temp_r27=0; temp_r27<3; temp_r27++) {
		...
		for(temp_r30=temp_r27+1; temp_r30<4; temp_r30++) {
			...
			temp_f18 = fn_1_68C4(temp_r29->unk1C.x, temp_r29->unk1C.z, temp_r29->unk34.x*lbl_1_bss_4, temp_r29->unk34.z*lbl_1_bss_4,
				temp_r29->unk58.z, temp_r28->unk1C.x, temp_r28->unk1C.z, temp_r28->unk34.x*lbl_1_bss_4, temp_r28->unk34.z*lbl_1_bss_4,
				temp_r28->unk58.z);
