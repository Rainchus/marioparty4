...
s32 fn_1_E72C(void)
{
    ...
    if(lbl_1_bss_4 == 3) {
        ...
        for(temp_r31=0; temp_r31<4; temp_r31++) {
            ...
            Hu3DModelAttrSet(lbl_1_bss_2C14[temp_r31], 0x40000001);
        }
        for(temp_r31=0; temp_r31<4; temp_r31++) {
        ...
        for(temp_r31=0; temp_r31<=30; temp_r31++) {
            ...
            for(temp_r30=0; temp_r30<4; temp_r30++) {
                Hu3DModelPosSet(lbl_1_bss_2C14[temp_r30], (sind(temp_f31*90.0f)*(((temp_r30*130)-195)-((temp_r30*130)+400)))+((temp_r30*130)+400), 0, 750);
    ...
    while(1) {
        for(temp_r31=temp_r22=0; temp_r31<30; temp_r31++) {
            ...
            if(temp_r30->pos.y > 350.0f) {
                Hu3DModelAttrSet(sp8[temp_r31], 1);
            } else {
                Hu3DModelAttrReset(sp8[temp_r31], 1);
