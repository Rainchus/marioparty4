...
omObjData *fn_1_1458(void)
{
    ...
    omObjData *var_r29 = omAddObjEx(lbl_1_bss_4, 1003, 0, 0, 1, NULL);
    UnkPresentStruct2 *var_r31 = HuMemDirectMallocNum(HEAP_SYSTEM, 868, MEMORY_DEFAULT_NUM);
...
void fn_1_20E8(omObjData *object)
{
    ...
    UnkPresentStruct2 *var_r31 = object->data;
    s32 var_r29 = var_r31->unk_238;
    s32 var_r27 = var_r31->unk_234;
    switch (object->unk10) {
        case 0:
            ...
            var_r31->unk_238 = 0;
            if (var_r31->unk_04) {
                s32 var_r25 = fn_1_3394(var_r31->unk_234);
                s32 var_r28;
...
void fn_1_2774(omObjData *object)
{
    ...
    if (var_r31->unk_248 < 1.0f) {
        float var_f31 = sin(90.0f * var_r31->unk_248 * M_PI / 180.0f);
        var_f31 *= var_f31;
...
s32 fn_1_2C5C(omObjData *object, s32 arg1)
{
    ...
    s32 var_r26;
    s32 var_r23;
    s32 var_r22 = fn_1_3394(var_r31->unk_234);
    s32 var_r18 = fn_1_2BCC(object, var_r31->unk_234);
    ...
    do {
        for (var_r23 = 0, var_r30 = 0; var_r30 < (var_r28 - 1); var_r30++) {
            if (spA4[var_r30].unk_04 > spA4[var_r30 + 1].unk_04) {
                UnkPresentStruct7 sp24 = spA4[var_r30 + 1];
