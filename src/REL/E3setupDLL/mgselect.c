...
char lbl_2_data_1A9[] = "\013TEST MINIGAME NAME13\000";
...
static char startText[] = "\013\016\r PRESS START\000\000\000\000";
...
static void UpdateMGSelect(omObjData *object)
{
	...
	if (object->work[3] != 0) {
		if ((var_r23 & 0x1100) != 0) {
			...
			e3ExitMode = 2;
			e3ExitEnableF = 1;
			var_r28 = mgOvlTbl[var_r31->unk44];
		...
		if (object->work[3] != 0) {
			...
			if (var_r31->unk46 != var_r31->unk44) {
				mgPicObj->work[0] = var_r31->unk44;
				var_r27 = var_r31->unk44 - var_r31->unk46;
				...
				var_r25 = var_r31->unk42 + var_r27;
				if ((var_r25 < 0) || (var_r25 >= 5)) {
					for (var_r30 = 0; var_r30 < 5; var_r30++) {
						var_r22 = var_r31->unk2E[var_r30];
						var_r26 = var_r31->unk38[var_r30];
						var_r24 = var_r26 - var_r27;
						if ((var_r24 < 0) || (var_r24 >= 5)) {
							var_r28 = mgNameTbl[var_r31->unk44];
						...
						var_r31->unk38[var_r30] = var_r26;
					}
				} else {
					var_r31->unk42 = var_r25;
					HuSprPosSet(var_r31->unk1C, 1, 0.0f, cursorYOfsTbl[var_r25]);
				}
				var_r31->unk46 = var_r31->unk44;
			}
		}
	}
}
...
static void CreateMGSelect(omObjData *object)
{
	...
	temp_r31->unk44 = var_r26;
	temp_r31->unk46 = var_r26;
	...
	for (var_r28 = 0; var_r28 < 5;) {
		...
		temp_r31->unk2E[var_r28] = temp_r29;
		temp_r31->unk38[var_r28] = var_r28;
...
static void CreateMGPic(omObjData *object)
{
	...
	for (var_r30 = 0; var_r30 < 13; var_r30++) {
		...
		temp_r28->unk00[var_r30] = temp_r3_2;
	...
	temp_r28->unk00[index2] = temp_r3_2;
...
static void CreateMGInterface(omObjData *object)
{
	...
	unkStruct->unk00[index2] = temp_r3_2;
