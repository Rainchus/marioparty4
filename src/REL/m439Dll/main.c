...
StructData748C lbl_1_data_748C[16] = {
	{
		0, 
		-1, 
		1, 
...
void fn_1_A18(Process *objman)
{
	...
	lbl_1_bss_40 = HuSprAnimRead(HuDataReadNum(0x460016, MEMORY_DEFAULT_NUM));
...
void fn_1_D0C(omObjData *object)
{
	...
	object->model[1] = Hu3DModelCreateFile(0x460012);
...
s32 fn_1_1128(Vec *arg0)
{
	...
	for(i=0; i<10; i++) {
		...
		temp_f26 = (((arg0->z*sp20[1])+((arg0->x*sp20[0])-(sp20[0]*lbl_1_data_76B0[i][0])))-(sp20[1]*lbl_1_data_76B0[i][1]))/((sp20[0]*sp20[0])+(sp20[1]*sp20[1]));
...
float lbl_1_data_7708[3][2][2] = {
	-99.8, -1431.8, 77.2, -1437.8, 
	-1499.8, -4571.8, -1322.8, -4577.8, 
	1300.2, -4571.8, 1477.2, -4577.8
};
...
s32 fn_1_16B0(Vec *arg0)
{
	...
	for(i=0; i<3; i++) {
		...
		temp_f26 = (((arg0->z*sp20[1])+((arg0->x*sp20[0])-(sp20[0]*lbl_1_data_7708[i][0][0])))-(sp20[1]*lbl_1_data_7708[i][0][1]))/((sp20[0]*sp20[0])+(sp20[1]*sp20[1]));
		if(temp_f26 >= 0.0f && temp_f26 < 1.0f) {
...
float fn_1_1C54(s32 arg0, Vec *arg1, Vec *arg2)
{
	...
	for(i=0; i<lbl_1_data_1074[arg0]-1; i++, temp_r31++, temp_r30++) {
		...
		temp_f29 = ((sp18.x*sp24.x)-(temp_r31->x*sp24.x)+(sp18.y*sp24.y)-(temp_r31->y*sp24.y)+(sp18.z*sp24.z)-(temp_r31->z*sp24.z))/temp_f31;
		VECSubtract(&temp_r30[1], &temp_r30[0], &sp24);
		temp_f31 = VECMag2Point(&sp24);
		if(temp_f31 == 0.0f) {
			continue;
		}
		temp_f28 = ((sp18.x*sp24.x)-(temp_r30->x*sp24.x)+(sp18.y*sp24.y)-(temp_r30->y*sp24.y)+(sp18.z*sp24.z)-(temp_r30->z*sp24.z))/temp_f31;
...
void fn_1_4AA8(omObjData *object)
{
	...
	object->model[0] = Hu3DModelCreateFile(0x460013);
...
s32 fn_1_67B4(Vec *arg0, s32 arg1, s32 arg2, Vec *arg3, Vec *arg4)
{
	...
	for(i=0; i<lbl_1_data_73B8[temp_r25]; i++) {
		...
		for(j=0; j<lbl_1_data_73F4[temp_r25][i]-1; j++, temp_r29++, temp_r31++, temp_r30++) {
			...
			temp_f31 = ((sp34.x*sp28.x)-(temp_r29->x*sp28.x)+(sp34.y*sp28.y)-(temp_r29->y*sp28.y)+(sp34.z*sp28.z)-(temp_r29->z*sp28.z))/temp_f30;
