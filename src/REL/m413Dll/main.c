...
const Vec lbl_1_rodata_10[2] = {
	0, 7955, 3436,
	0, -0.898794f, -0.43837115f
};

const GXColor lbl_1_rodata_28 = {
	0, 0, 0, 255
};

const Vec lbl_1_rodata_2C[2] = {
	0, 5966.25f, 3436,
	0, -0.6740955f, -0.43837115f
};

const GXColor lbl_1_rodata_44 = {
	0, 0, 0, 255
};
...
void fn_1_A0(s32 arg0)
{
	...
	MTXTrans(spC, (((HuPadBtn[0] & PAD_BUTTON_RIGHT) != 0)-((HuPadBtn[0] & PAD_BUTTON_LEFT) != 0))*10.0,
		(((HuPadBtn[0] & PAD_BUTTON_UP) != 0)-((HuPadBtn[0] & PAD_BUTTON_DOWN) != 0))*10.0,
		((HuPadTrigL[0]-HuPadTrigR[0])/128.0)*30.0);
...
void fn_1_EC0(Work19C8 *arg0)
{
	...
	for(temp_r30=0; temp_r30<8; temp_r30++) {
		if(arg0->unk50[temp_r30][0] == arg0->unk50[temp_r30][1]) {
			do {
				temp_r29 = rand8()%8;
			} while(temp_r30 == temp_r29 || arg0->unk50[temp_r30][0] == arg0->unk50[temp_r29][0] || arg0->unk50[temp_r30][0] == arg0->unk50[temp_r29][1]);
			...
			if(temp_r31 != sp44[temp_r30==2] || temp_r30 != 3) {
				if(temp_r31 != sp3C[temp_r30==2]-1 || temp_r30 != 1) {
					...
					for(temp_r25=0; temp_r25<2; temp_r25++) {
						...
						spAC[temp_r30][temp_r31] = (spAC[temp_r30][temp_r31] < 3) ? ((3-spAC[temp_r30][temp_r31])*(3-spAC[temp_r30][temp_r31])) : 0;
						...
						for(temp_r28=temp_r24-2; temp_r28<=temp_r24+2; temp_r28++) {
							...
							for(temp_r29=temp_r23-2; temp_r29<=temp_r23+2; temp_r29++) {
								...
								if(sp16C[temp_r28][temp_r29] == 5) {
									...
									spAC[temp_r30][temp_r31] += sp78[temp_r28-(temp_r24-2)][temp_r29-(temp_r23-2)]/((arg0->unk20 == 0) ? 4 : 1);
								}
							}
						}
					}
...
void fn_1_19C8(omObjData *object)
{
	...
	if(temp_r31->unk1C != -1) {
		...
		sp19C = (temp_r31->unk72 == 1 && temp_r31->unk7C != -1) ? ((temp_r31->unk48[0]) ? ((temp_r31->unk7C < temp_r31->unk48[0]->unk18) ? -1 : (temp_r31->unk7C > temp_r31->unk48[0]->unk18) ? 1 : 0) : 0) : 0;
	}
	...
	if(temp_r31->unk72 == 2) {
		...
		temp_r31->unkA0 = (temp_r31->unk74 == 0) ? temp_f30 : ((temp_r31->unkA0-10 > temp_f30) ? (temp_r31->unkA0-10) : (((temp_r31->unkA0 > temp_f30) ? temp_f30 : ((temp_r31->unkA0+10 < temp_f30) ? (temp_r31->unkA0+10) : ((temp_r31->unkA0 < temp_f30) ? temp_f30 : temp_r31->unkA0)))));
		temp_r31->unk74++;
		...
		if(lbl_1_bss_44->work[0] == 1002 && temp_r31->unk74 >= 24) {
    		...
    		if(temp_r23 != 3) {
    			...
    			for(temp_r23=0; temp_r23<2; temp_r23++) {
    				...
    				lbl_1_bss_2A6C[temp_r25].unk8[0] = lbl_1_bss_2A6C[temp_r25].unk8[1] = lbl_1_bss_2A6C[temp_r25].unk8[2] = lbl_1_bss_2A6C[temp_r25].unk8[3] = 0;
		...
		if(!temp_r31->unk48[0] || !temp_r31->unk48[1]) {
			...
			if(temp_r31->unk1C != -1) {
				temp_r26 = (HuPadBtnDown[temp_r31->unk1C] & (PAD_BUTTON_X|PAD_BUTTON_Y)) ? (temp_r31->unk70+2) : (temp_r31->unk70+((HuPadBtnDown[temp_r31->unk1C] & PAD_BUTTON_A) ? 1 : 0) + ((HuPadBtnDown[temp_r31->unk1C] & PAD_BUTTON_B) ? -1 : 0));
			} else {
			...
			if(temp_r31->unk1C == -1) {
				...
				temp_r31->unk8C = temp_r31->unk48[0]->unk18;
				if(temp_r31->unk7C == -1 && temp_r31->unk90 >= sp20C[temp_r31->unk20] || (temp_r31->unk20 >= 1 && (temp_r31->unk90 >= sp200[temp_r31->unk20-1]))) {
			...
			if(lbl_1_bss_18 == -1) {
				if(temp_r31->unk1C != -1) {
					temp_r31->unk48[0]->unk1C.z = temp_r31->unk48[1]->unk1C.z = -0.03125f+((HuPadStkY[temp_r31->unk1C] < -36) ? (-0.26875f*((-HuPadStkY[temp_r31->unk1C]-36)/36.0f)) : 0);
					temp_r31->unk4 = (HuPadStkY[temp_r31->unk1C] < -36) ? 1 : 0;
				} else {
					s32 sp1E4[3] = { 50, 30, 25 };
					s32 sp1D8[3] = { 90, 80, 70 };

					temp_r31->unk4 = ((temp_r31->unk20 && (temp_r31->unk88 > temp_r31->unk94+sp1E4[temp_r31->unk20-1] || temp_r31->unk90 > sp1D8[temp_r31->unk20-1]))) ? 1 : 0;
...
void fn_1_52A4(s32 arg0)
{
			...
			if(temp_r31->unk0) {
				...
				if(sp1DC != 0) {
					if(temp_r31->unk1 & 0x2) {
						...
						if(temp_r31->unk50->unk71 == 0 || temp_r31->unk50->unk4 != 0 && (!sp1D8 || ((sp1D8->unk1 & 0x1) && (sp1D8->unk1 & 0x2) == 0))) {
							...
							if(temp_r31->unk50->unk48[0]->unk18 != temp_r31->unk50->unk48[1]->unk18) {
								...
								if(sp1D4 == 1) {
									...
									if(temp_r21) {
										if((!temp_r20 && temp_r21->unk1C.y == 0.0f) || (temp_r20 && temp_r21->unk1C.y == temp_r20->unk1C.y+1.0f && (temp_r20->unk1 & 0x1) && (temp_r20->unk1 & 0x2) == 0)) {
											temp_r21->unk1C.y = (temp_r20) ? (temp_r20->unk1C.y+1.0f) : 0.0f;
											temp_r21->unk1 &= ~0x1;
											temp_r21->unk1 |= (temp_r20 && ((temp_r20->unk1 & 0x1) == 0 || (temp_r20->unk1 & 0x2) != 0)) ? 0 : 1;
											temp_r21->unk1C.z = (temp_r21->unk1 & 0x1) ? -0.010416667f : ((!temp_r20) ? -0.010416667f : temp_r20->unk1C.z);
											sp1E8 = temp_r21;
										}
									}
								}
	...
	temp_r23 = 0;
	{
						...
						if(temp_r30 && (temp_r30->unk1 & 0x1)) {
							if(temp_r29 != 1 || temp_r31->unk1C.y == temp_r30->unk1C.y) {
								if(temp_r31->unk0 == temp_r30->unk0) {
									if((temp_r31->unk0 >= 1 && temp_r31->unk0 <= 4) || (temp_r31->unk0 == 5 && (temp_r31->unk1C.y <= 8.0f || temp_r30->unk1C.y <= 8.0f))) {
										...
										if(temp_r31->unk2C && temp_r30->unk2C) {
											...
											if(temp_r31->unk2C) {
												...
												sp14C8[temp_r23].unk4[0] = (temp_r31->unk8[0] > temp_r30->unk8[0]) ? temp_r31->unk8[0] : temp_r30->unk8[0];
												sp14C8[temp_r23].unk4[1] = (temp_r31->unk8[1] > temp_r30->unk8[1]) ? temp_r31->unk8[1] : temp_r30->unk8[1];
												sp14C8[temp_r23].unk4[2] = (temp_r31->unk8[2] > temp_r30->unk8[2]) ? temp_r31->unk8[2] : temp_r30->unk8[2];
												sp14C8[temp_r23].unk4[3] = (temp_r31->unk8[3] > temp_r30->unk8[3]) ? temp_r31->unk8[3] : temp_r30->unk8[3];
		...
		while(sp1B4 >= 0) {
			...
			s32 sp188 = 0;
			for(temp_r29=0; temp_r29<temp_r23; temp_r29++) {
				if((!sp1B4 && (sp14C8[temp_r29].unk0 >= 1 && sp14C8[temp_r29].unk0 <= 4 && sp14C8[temp_r29].unk1 >= 3)) || (sp1B4 == 1 && sp14C8[temp_r29].unk0 == 5)) {
					...
					for(temp_r19=0; temp_r19<sp14C8[temp_r29].unk1; temp_r19++) {
						...
						if(sp14C8[temp_r29].unk0 == 5) {
							if(lbl_1_bss_D4[lbl_1_bss_D0][0] < 10) {
								Hu3DModelPosSet(lbl_1_bss_30->model[((lbl_1_bss_D0*10)+13+lbl_1_bss_D4[lbl_1_bss_D0][0])], (((temp_r26->unk18*100)-500.0)-50.0), 50.0f+((100.0f*temp_r26->unk1C.y)-500.0f), 120);
					...
					if(lbl_1_bss_48[(sp14C8[temp_r29].unk0 == 5) ? 0 : 1].unk0 < 3) {
						lbl_1_bss_48[(sp14C8[temp_r29].unk0 == 5) ? 0 : 1].unk4[lbl_1_bss_48[(sp14C8[temp_r29].unk0 == 5) ? 0 : 1].unk0] =  0.45*(((temp_f31-5.0)-0.5)/5.5);
...
void fn_1_8C10(omObjData *object)
{
	...
	for(temp_r31=0; temp_r31<4; temp_r31++) {
		...
		for(temp_r30=0; temp_r30<3; temp_r30++) {
			...
			float temp_f25 = (temp_r30 == 0) ? ((sp88[temp_r31]->unk24/100)%10) : ((temp_r30 == 1) ? ((sp88[temp_r31]->unk24/10)%10) :  sp88[temp_r31]->unk24%10);
		...
		do {
			...
			if(lbl_1_bss_2684[temp_r29].unkC == 0 || (lbl_1_bss_2684[temp_r29].unk10 & 0xF) == 0) {
				...
				for(temp_r24=0; temp_r24<temp_r18; temp_r28++, temp_r24++) {
					HuSprPosSet(lbl_1_bss_14, temp_r28, (temp_r24*14)+(lbl_1_bss_2684[temp_r29].unk0-((temp_r18*14)/2)), lbl_1_bss_2684[temp_r29].unk4-lbl_1_bss_2684[temp_r29].unkC);
					...
					HuSprTPLvlSet(lbl_1_bss_14, temp_r28, (lbl_1_bss_2684[temp_r29].unkC <= 30) ? 1.0f : (1.0f-((lbl_1_bss_2684[temp_r29].unkC-30)/10.0f)));
					HuSprBankSet(lbl_1_bss_14, temp_r28, (temp_r24 == 0) ? 10 : ((temp_r24 == 2 || temp_r18 == 2) ? lbl_1_bss_2684[temp_r29].unk8%10 : ((lbl_1_bss_2684[temp_r29].unk8/10)%10)));
				}
			}
	...
	switch(object->work[0]) {
		case 1000:
			if(!WipeStatGet()) {
				...
				temp_r29 = (lbl_1_bss_2C >= 235.0f) ? 255 : ((lbl_1_bss_2C >= 205.0f) ? 192 : ((lbl_1_bss_2C >= 190.0f) ? 128 : (((lbl_1_bss_2C >= 160.0f) ? 64 : 0))));
				...
				Hu3DMotionSpeedSet(lbl_1_bss_30->model[0], 0.5*((lbl_1_bss_2C < 100.0f) ? 0.0 : ((lbl_1_bss_2C < 320.0f) ? ((lbl_1_bss_2C-100)/220.0) :  1.0)));
				for(temp_r26=0; temp_r26<4; temp_r26++) {
					Hu3DMotionSpeedSet(lbl_1_bss_34[temp_r26]->model[5], 0.5*((lbl_1_bss_2C < 100.0f) ? 0.0 : ((lbl_1_bss_2C < 280.0f) ? ((lbl_1_bss_2C-100)/180.0) :  1.0)));
				}
			...
			for(temp_r31 = lbl_1_bss_7884[temp_r27]; temp_r31; temp_r31=temp_r31->unk48) {
				...
				if(temp_r31->unk0) {
					...
					if(sp60[temp_r31->unk0] != -1) {
						s32 temp_r21 = sp60[temp_r31->unk0]+(temp_r31->unk0 == 5 && ((temp_r31->unk1C.z < 0.0f && (temp_r31->unk1 & 0x1) == 0) || (temp_r31->unk1 & 0x2) != 0));
...
void fn_1_C6E0(omObjData *object)
{
	...
	object->model[0] = Hu3DModelCreateFile(0x2C0000);
	omSetTra(object, 0, 0, 0);
	Hu3DMotionSpeedSet(object->model[0], 0);
	object->model[1] = Hu3DModelCreateFile(0x2C0001);
	...
	for(temp_r30=0; temp_r30<4; temp_r30++) {
		object->model[temp_r30+3] = Hu3DModelCreateFile(0x2C0003+temp_r30);
		Hu3DModelAttrSet(object->model[temp_r30+3], 1);
		object->model[temp_r30+7] = Hu3DModelCreateFile(0x2C0007+temp_r30);
	...
	for(temp_r30=0; temp_r30<5; temp_r30++) {
		s32 temp_r29;
		object->model[(temp_r30*10)+13] = Hu3DModelCreateFile(0x2C001E);
	...
	{
		void *temp_r27 = HuDataSelHeapReadNum(0x2C001F, MEMORY_DEFAULT_NUM, HEAP_DATA);
...
void fn_1_CBB4(omObjData *object)
{
	...
	temp_r31->unk98 = 0;
	temp_r31->unk9C = 0;
	object->model[0] = Hu3DModelCreateFile(0x2C0002);
	...
	object->model[4] = Hu3DModelCreateFile(0x2C000D+temp_r31->unk18);
	...
	object->model[5] = Hu3DModelCreateFile(0x2C0015+temp_r31->unk18);
	...
	{
		AnimData *temp_r23 = HuSprAnimReadFile(0x610038+GWPlayerCfg[temp_r31->unk14].character);
		s16 temp_r22;
