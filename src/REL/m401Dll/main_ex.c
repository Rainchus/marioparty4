...
{
	s32 i;
	lbl_2_bss_250 = HuSprAnimReadFile(0x200011);
	lbl_2_bss_24C = HuSprAnimReadFile(0x200012);
	lbl_2_bss_248 = HuSprAnimReadFile(0x200013);
	lbl_2_bss_240 = HuSprAnimReadFile(0x200014);
	lbl_2_bss_23C = HuSprAnimReadFile(0x200015);
	lbl_2_bss_238 = HuSprAnimReadFile(0x200016);
	...
	lbl_2_bss_244 = HuSprAnimReadFile(0x200026);
	...
	for(i=0; i<4; i++) {
		lbl_2_bss_136[i] = Hu3DModelCreateFile(0x200017);
